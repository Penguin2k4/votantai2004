...
![Tạo CloudWatch Log Group](/images/5-Workshop/5.3.7-CloudWatch/log-group-create.png)
...
![Log Group đã tạo](/images/5-Workshop/5.3.7-CloudWatch/log-group-created.png)
...
![Các Log Stream của ứng dụng](/images/5-Workshop/5.3.7-CloudWatch/log-streams.png)
