...
![General EFS settings](/images/5-Workshop/5.3.6-EFS/efs-settings.png)

![Performance and lifecycle settings](/images/5-Workshop/5.3.6-EFS/efs-performance.png)
...
![EFS network access](/images/5-Workshop/5.3.6-EFS/efs-network.png)
...
![Review EFS](/images/5-Workshop/5.3.6-EFS/efs-review.png)

![Created EFS file system](/images/5-Workshop/5.3.6-EFS/efs-created.png)
...
![EFS Access Point configuration](/images/5-Workshop/5.3.6-EFS/access-point-settings.png)
...
![Created Access Point](/images/5-Workshop/5.3.6-EFS/access-point-created.png)
