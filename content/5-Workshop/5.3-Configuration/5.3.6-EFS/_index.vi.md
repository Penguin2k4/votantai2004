...
![Cấu hình chung của EFS](/images/5-Workshop/5.3.6-EFS/efs-settings.png)

![Cấu hình hiệu năng và lifecycle](/images/5-Workshop/5.3.6-EFS/efs-performance.png)
...
![Network Access của EFS](/images/5-Workshop/5.3.6-EFS/efs-network.png)
...
![EFS đã tạo](/images/5-Workshop/5.3.6-EFS/efs-created.png)
...
![Cấu hình EFS Access Point](/images/5-Workshop/5.3.6-EFS/access-point-settings.png)
...
![Access Point đã tạo](/images/5-Workshop/5.3.6-EFS/access-point-created.png)
