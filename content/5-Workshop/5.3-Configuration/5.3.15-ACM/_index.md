...
![Start the certificate request](/images/5-Workshop/5.3.15-ACM/certificate-start.png)
...
![Certificate domain configuration](/images/5-Workshop/5.3.15-ACM/certificate-domain.png)
...
![Create the DNS validation record](/images/5-Workshop/5.3.15-ACM/dns-validation-records.png)

## 4. Wait for certificate issuance

Wait until the status changes from `Pending validation` to `Issued`.

![Issued certificate](/images/5-Workshop/5.3.15-ACM/certificate-issued.png)
