...
![Bắt đầu request certificate](/images/5-Workshop/5.3.15-ACM/certificate-start.png)
...
![Khai báo domain certificate](/images/5-Workshop/5.3.15-ACM/certificate-domain.png)
...
![Tạo DNS validation record](/images/5-Workshop/5.3.15-ACM/dns-validation-records.png)

## 4. Chờ certificate được cấp

Đợi trạng thái chuyển từ `Pending validation` sang `Issued`.

![Certificate ở trạng thái Issued](/images/5-Workshop/5.3.15-ACM/certificate-issued.png)
