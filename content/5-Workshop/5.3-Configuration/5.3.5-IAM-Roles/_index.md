...
![Select the trusted entity](/images/5-Workshop/5.3.5-IAM-Roles/execution-role-trusted-entity.png)
...
![Inline policy for the secret](/images/5-Workshop/5.3.5-IAM-Roles/secret-policy-redacted.png)
...
![Created Execution Role](/images/5-Workshop/5.3.5-IAM-Roles/execution-role-created.png)
...
![Created Task Role](/images/5-Workshop/5.3.5-IAM-Roles/task-role-created.png)
...
![Verify attached permissions](/images/5-Workshop/5.3.5-IAM-Roles/secret-policy-attached.png)
