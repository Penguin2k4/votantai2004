...
![Chọn trusted entity cho Execution Role](/images/5-Workshop/5.3.5-IAM-Roles/execution-role-trusted-entity.png)
...
![Inline policy đọc secret](/images/5-Workshop/5.3.5-IAM-Roles/secret-policy-redacted.png)
...
![Execution Role đã tạo](/images/5-Workshop/5.3.5-IAM-Roles/execution-role-created.png)
...
![Task Role đã tạo](/images/5-Workshop/5.3.5-IAM-Roles/task-role-created.png)
...
![Kiểm tra policy đã gắn](/images/5-Workshop/5.3.5-IAM-Roles/secret-policy-attached.png)
