...
![Cấu hình Target Group](/images/5-Workshop/5.3.11-Target-Group/target-group-create.png)
...
![Cấu hình Health Check](/images/5-Workshop/5.3.11-Target-Group/health-check.png)
...
![Thuộc tính Target Group](/images/5-Workshop/5.3.11-Target-Group/target-group-attributes.png)

Không đăng ký IP thủ công. ECS Service sẽ thêm và gỡ IP task tự động.

![Review Target Group](/images/5-Workshop/5.3.11-Target-Group/target-group-review.png)

![Target Group đã tạo](/images/5-Workshop/5.3.11-Target-Group/target-group-created.png)
