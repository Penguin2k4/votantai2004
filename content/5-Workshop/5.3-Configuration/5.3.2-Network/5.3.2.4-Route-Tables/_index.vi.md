...
![Tạo Public Route Table](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-route-table-create.png)
...
![Gắn hai public subnet](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-subnet-associations.png)
...
![Thêm default route đến Internet Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-default-route.png)

![Public Route Table hoàn tất](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-route-table-complete.png)
...
![Tạo Private Route Table](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-route-table-create.png)

Trong **Subnet associations**, chỉ chọn `malscanai-subnet-private-1`.

![Gắn private subnet](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-subnet-association.png)
...
![Thêm route đến NAT Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-default-route.png)

![Private Route Table hoàn tất](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-route-table-complete.png)
