...
![Create the Public Route Table](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-route-table-create.png)
...
![Associate the public subnets](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-subnet-associations.png)
...
![Add the default route to the Internet Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-default-route.png)

![Completed Public Route Table](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/public-route-table-complete.png)
...
![Create the Private Route Table](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-route-table-create.png)

Under **Subnet associations**, select only `malscanai-subnet-private-1`.

![Associate the private subnet](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-subnet-association.png)
...
![Add the route to the NAT Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-default-route.png)

![Completed Private Route Table](/images/5-Workshop/5.3.2-Network/5.3.2.4-Route-Tables/private-route-table-complete.png)
