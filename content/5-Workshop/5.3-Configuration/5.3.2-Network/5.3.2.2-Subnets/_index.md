...
![Public Subnet 1 configuration](/images/5-Workshop/5.3.2-Network/5.3.2.2-Subnets/public-subnet-1.png)
...
![Public Subnet 2 configuration](/images/5-Workshop/5.3.2-Network/5.3.2.2-Subnets/public-subnet-2.png)
...
![Private Subnet 1 configuration](/images/5-Workshop/5.3.2-Network/5.3.2.2-Subnets/private-subnet-1.png)
...
![Created subnets](/images/5-Workshop/5.3.2-Network/5.3.2.2-Subnets/subnets-created.png)
...
![Enable public IPv4 for Public Subnet 1](/images/5-Workshop/5.3.2-Network/5.3.2.2-Subnets/public-ip-subnet-1.png)

Repeat the same step for `malscanai-subnet-public-2`.

![Enable public IPv4 for Public Subnet 2](/images/5-Workshop/5.3.2-Network/5.3.2.2-Subnets/public-ip-subnet-2.png)
