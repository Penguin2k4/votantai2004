...
![Tạo Internet Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/internet-gateway-create.png)

Sau khi tạo, chọn **Actions → Attach to a VPC**, chọn `malscanai-vpc`, rồi xác nhận.

![Chọn VPC để gắn Internet Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/internet-gateway-attach.png)

![Internet Gateway đã gắn với VPC](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/internet-gateway-attached.png)
...
![Cấp Elastic IP](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/elastic-ip.png)
...
![Cấu hình NAT Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/nat-gateway-create.png)

Chọn **Create NAT gateway** và đợi trạng thái chuyển sang `Available`.

![NAT Gateway ở trạng thái Available](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/nat-gateway-created.png)
