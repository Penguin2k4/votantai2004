...
![Create the Internet Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/internet-gateway-create.png)

After creation, choose **Actions → Attach to a VPC**, select `malscanai-vpc`, and confirm.

![Select the VPC](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/internet-gateway-attach.png)

![Internet Gateway attached to the VPC](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/internet-gateway-attached.png)
...
![Allocate an Elastic IP](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/elastic-ip.png)
...
![NAT Gateway configuration](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/nat-gateway-create.png)

Choose **Create NAT gateway** and wait until its state becomes `Available`.

![Available NAT Gateway](/images/5-Workshop/5.3.2-Network/5.3.2.3-Internet-Access/nat-gateway-created.png)
