...
![VPC configuration](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/vpc-settings.png)
...
![Created VPC](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/vpc-created.png)
...
![Enable DNS resolution and hostnames](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/dns-settings.png)

Choose **Save changes** and confirm that both settings are enabled.

![DNS settings enabled](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/dns-enabled.png)
