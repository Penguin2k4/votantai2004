...
![Khai báo VPC](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/vpc-settings.png)
...
![VPC đã tạo](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/vpc-created.png)
...
![Bật DNS resolution và DNS hostnames](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/dns-settings.png)

Chọn **Save changes**, sau đó kiểm tra hai tùy chọn đã ở trạng thái Enabled.

![DNS đã được bật](/images/5-Workshop/5.3.2-Network/5.3.2.1-VPC/dns-enabled.png)
