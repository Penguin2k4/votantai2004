...
![Redacted Custom Origin Header](/images/5-Workshop/5.3.17-Protect-ALB/custom-header-redacted.png)
...
![Open the listener rules](/images/5-Workshop/5.3.17-Protect-ALB/listener-rules.png)
...
![HTTP header condition](/images/5-Workshop/5.3.17-Protect-ALB/header-condition.png)
...
![Forward to the Target Group](/images/5-Workshop/5.3.17-Protect-ALB/forward-action.png)

Set the rule priority so that the header rule is evaluated before the default rule.

![Set listener rule priority](/images/5-Workshop/5.3.17-Protect-ALB/rule-priority.png)

![Review the listener rule](/images/5-Workshop/5.3.17-Protect-ALB/rule-review.png)
...
![Default rule returns 403](/images/5-Workshop/5.3.17-Protect-ALB/default-403.png)
