...
![Custom Origin Header đã che giá trị](/images/5-Workshop/5.3.17-Protect-ALB/custom-header-redacted.png)
...
![Mở Listener Rules](/images/5-Workshop/5.3.17-Protect-ALB/listener-rules.png)
...
![Điều kiện HTTP Header](/images/5-Workshop/5.3.17-Protect-ALB/header-condition.png)
...
![Forward đến Target Group](/images/5-Workshop/5.3.17-Protect-ALB/forward-action.png)

Đặt priority cho rule để rule kiểm tra header được xử lý trước default rule.

![Đặt priority cho Listener Rule](/images/5-Workshop/5.3.17-Protect-ALB/rule-priority.png)

![Review Listener Rule](/images/5-Workshop/5.3.17-Protect-ALB/rule-review.png)
...
![Default Rule trả về 403](/images/5-Workshop/5.3.17-Protect-ALB/default-403.png)
