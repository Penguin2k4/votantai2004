...
![Select the CloudFront plan](/images/5-Workshop/5.3.16-CloudFront/cloudfront-plan.png)

![Start creating the Distribution](/images/5-Workshop/5.3.16-CloudFront/cloudfront-start.png)
...
![Select the ALB origin](/images/5-Workshop/5.3.16-CloudFront/cloudfront-origin.png)
...
![Cache Behavior configuration](/images/5-Workshop/5.3.16-CloudFront/cloudfront-settings.png)

![Allowed HTTP methods](/images/5-Workshop/5.3.16-CloudFront/cloudfront-methods.png)
...
![WAF configuration](/images/5-Workshop/5.3.16-CloudFront/cloudfront-waf.png)
...
![Review CloudFront](/images/5-Workshop/5.3.16-CloudFront/cloudfront-review.png)

![Created CloudFront Distribution](/images/5-Workshop/5.3.16-CloudFront/cloudfront-created.png)
...
![Add the alternate domain name](/images/5-Workshop/5.3.16-CloudFront/alternate-domain.png)

Select the ACM certificate with status `Issued` in `us-east-1`.

![Select the ACM certificate](/images/5-Workshop/5.3.16-CloudFront/certificate-selected.png)
...
![Create the Alias to CloudFront](/images/5-Workshop/5.3.16-CloudFront/route53-alias.png)
