...
![Chọn CloudFront plan](/images/5-Workshop/5.3.16-CloudFront/cloudfront-plan.png)

![Bắt đầu tạo Distribution](/images/5-Workshop/5.3.16-CloudFront/cloudfront-start.png)
...
![Chọn ALB làm Origin](/images/5-Workshop/5.3.16-CloudFront/cloudfront-origin.png)
...
![Cấu hình Cache Behavior](/images/5-Workshop/5.3.16-CloudFront/cloudfront-settings.png)
...
![Cấu hình WAF](/images/5-Workshop/5.3.16-CloudFront/cloudfront-waf.png)
...
![CloudFront Distribution đã tạo](/images/5-Workshop/5.3.16-CloudFront/cloudfront-created.png)
...
![Thêm Alternate Domain Name](/images/5-Workshop/5.3.16-CloudFront/alternate-domain.png)

Chọn certificate ACM đã `Issued` trong `us-east-1`.

![Chọn ACM certificate](/images/5-Workshop/5.3.16-CloudFront/certificate-selected.png)
...
![Tạo Alias đến CloudFront](/images/5-Workshop/5.3.16-CloudFront/route53-alias.png)
