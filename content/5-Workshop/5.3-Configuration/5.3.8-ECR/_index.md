...
![Create the Streamlit repository](/images/5-Workshop/5.3.8-ECR/repository-streamlit.png)
...
![Create the URL Engine repository](/images/5-Workshop/5.3.8-ECR/repository-url-engine.png)

![Created repositories](/images/5-Workshop/5.3.8-ECR/repositories-created.png)

## 3. Verify the local images

Before pushing, confirm that both images are available locally.

![Local Docker images](/images/5-Workshop/5.3.8-ECR/local-docker-images.png)
...
![Push both images to ECR](/images/5-Workshop/5.3.8-ECR/push-images.png)

## 5. Verify the images in ECR

Open each repository and confirm that tag `v1` is available.

![Streamlit image in ECR](/images/5-Workshop/5.3.8-ECR/streamlit-image-in-ecr.png)

![URL Engine image in ECR](/images/5-Workshop/5.3.8-ECR/url-engine-image-in-ecr.png)
