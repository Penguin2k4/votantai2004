...
![ALB basic settings](/images/5-Workshop/5.3.12-ALB/alb-basic-settings.png)
...
![ALB network mapping](/images/5-Workshop/5.3.12-ALB/alb-network.png)
...
![Select the ALB security group](/images/5-Workshop/5.3.12-ALB/alb-security-group-select.png)
...
![ALB listener configuration](/images/5-Workshop/5.3.12-ALB/alb-listener.png)
...
![Review the ALB](/images/5-Workshop/5.3.12-ALB/alb-review.png)

Wait until the state becomes `Active`.

![Created ALB](/images/5-Workshop/5.3.12-ALB/alb-created.png)

## 5. Check ALB attributes

Open the **Attributes** tab and review the idle timeout and connection settings.

![ALB attributes](/images/5-Workshop/5.3.12-ALB/alb-attributes.png)
