...
![Cấu hình cơ bản của ALB](/images/5-Workshop/5.3.12-ALB/alb-basic-settings.png)
...
![Network mapping của ALB](/images/5-Workshop/5.3.12-ALB/alb-network.png)
...
![Chọn Security Group cho ALB](/images/5-Workshop/5.3.12-ALB/alb-security-group-select.png)
...
![Cấu hình listener của ALB](/images/5-Workshop/5.3.12-ALB/alb-listener.png)
...
![Review ALB](/images/5-Workshop/5.3.12-ALB/alb-review.png)

Đợi trạng thái chuyển sang `Active`.

![ALB đã tạo](/images/5-Workshop/5.3.12-ALB/alb-created.png)

## 5. Kiểm tra thuộc tính ALB

Trong tab **Attributes**, nhóm kiểm tra idle timeout và các thuộc tính kết nối.

![Thuộc tính ALB](/images/5-Workshop/5.3.12-ALB/alb-attributes.png)
