...
![Bắt đầu tạo ECS Service](/images/5-Workshop/5.3.13-ECS-Service/service-start.png)
...
![Cấu hình cơ bản của Service](/images/5-Workshop/5.3.13-ECS-Service/service-basic.png)
...
![Cấu hình deployment](/images/5-Workshop/5.3.13-ECS-Service/service-deployment.png)
...
![Network của ECS Service](/images/5-Workshop/5.3.13-ECS-Service/service-network.png)
...
![Gắn ALB và Target Group](/images/5-Workshop/5.3.13-ECS-Service/service-load-balancer.png)
...
![Review ECS Service](/images/5-Workshop/5.3.13-ECS-Service/service-review.png)

![ECS Service đã tạo](/images/5-Workshop/5.3.13-ECS-Service/service-created.png)

Sau vài phút, task chuyển sang `Running` và target chuyển sang `Healthy`.

![Target ở trạng thái Healthy](/images/5-Workshop/5.3.13-ECS-Service/target-healthy.png)
