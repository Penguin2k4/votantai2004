...
![Start creating the ECS Service](/images/5-Workshop/5.3.13-ECS-Service/service-start.png)
...
![Basic Service configuration](/images/5-Workshop/5.3.13-ECS-Service/service-basic.png)
...
![Deployment configuration](/images/5-Workshop/5.3.13-ECS-Service/service-deployment.png)
...
![ECS Service networking](/images/5-Workshop/5.3.13-ECS-Service/service-network.png)
...
![Attach the ALB and Target Group](/images/5-Workshop/5.3.13-ECS-Service/service-load-balancer.png)
...
![Review the ECS Service](/images/5-Workshop/5.3.13-ECS-Service/service-review.png)

![Created ECS Service](/images/5-Workshop/5.3.13-ECS-Service/service-created.png)

After a few minutes, the task becomes `Running` and the target becomes `Healthy`.

![Healthy target](/images/5-Workshop/5.3.13-ECS-Service/target-healthy.png)
