...
![Cấu hình infrastructure của Task Definition](/images/5-Workshop/5.3.10-Task-Definition/task-infrastructure.png)
...
![Cấu hình container Streamlit](/images/5-Workshop/5.3.10-Task-Definition/streamlit-container.png)
...
![Biến môi trường, secret và log của Streamlit](/images/5-Workshop/5.3.10-Task-Definition/streamlit-environment-logging.png)
...
![Cấu hình container URL Engine](/images/5-Workshop/5.3.10-Task-Definition/url-engine-container.png)
...
![Khai báo EFS volume](/images/5-Workshop/5.3.10-Task-Definition/efs-volume.png)
...
![Task Definition đã tạo](/images/5-Workshop/5.3.10-Task-Definition/task-definition-created.png)
